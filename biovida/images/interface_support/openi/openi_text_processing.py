...
def _imaging_modality_guess_info():
    ...
    # Add all possible contradictions generated by 'abdomen', 'chest', 'head' and 'spinal'.
    contradictions += list(map(list, combinations(['abdomen', 'chest', 'head', 'spinal'], r=2)))

    return terms_dict, modality_subtypes, contradictions


def _imaging_modality_guess(abstract, image_caption):
    """
...
# a = _imaging_modality_guess(abstract='mri t1 images were taken',
#                               image_caption='T2 hyperintensity within the cord at C3 and C4 with mild expansion of the cord.',
#                               image_mention='')
# print(a)
...
def feature_extract(x, list_of_diseases):
    ...
    d['caption_imaging_modality'] = _imaging_modality_guess(x['abstract'], x['image_caption'])
