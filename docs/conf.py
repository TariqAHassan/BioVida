...
# -*- coding: utf-8 -*-
#
# BioVida documentation build configuration file, created by
# sphinx-quickstart on Tue Aug 30 17:36:40 2016.
#
...
latex_documents = [
    (master_doc, 'BioVida.tex', 'BioVida Documentation',
     'Tariq A. Hassan', 'manual'),
]
...
man_pages = [
    (master_doc, 'biovida', 'BioVida Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BioVida', 'BioVida Documentation',
     author, 'BioVida', 'One line description of project.',
     'Miscellaneous'),
]
